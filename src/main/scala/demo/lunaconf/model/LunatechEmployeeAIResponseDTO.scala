...
case class LunatechEmployeeAIResponseDTO(firstName: String, lastName: String, dob: LocalDate, doj: LocalDate) {
  override def toString: String = {
    s"name: $firstName, $lastName, Dob: $dob, DOJ: $doj"
  }
}

case class LunatechEmployee(firstName: Option[String], lastName: Option[String], dob: Option[LocalDate], doj:Option[LocalDate])
